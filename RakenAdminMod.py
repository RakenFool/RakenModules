...
class RakenMod(loader.Module):
    ...
    strings = {'name': 'RakenAdminMod',
               ...
               'demoted': '<b></b> <i>✅{} разжалован!</i>',
               'pinning': '<b></b><i>✅ Закрепляем...</i>',
               'pin_none': '<b></b><i>❌ Реплай для кого сделали, а?</i>',
               'unpinning': '<b></b> <i>✅ Открепляем...</i>',
               'unpin_none': '<b></b><i>❌ Нечего откреплять.</i>',
               'no_rights': '<b></b> <i>❌ Иди попрошайничать админку. У тебя ее здесь нет.</i>',
               'pinned': '<b></b> <i>✅ Закреплено успешно!</i>',
               'unpinned': '<b></b><i>✅ Откреплено успешно!</i>',
