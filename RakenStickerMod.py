# требует: git+https://gitlab.com/mattia.basaglia/python-lottie@master cairosvg Pillow>=6.1.0
# исходник: Friendly-telegram
...
class StickersMod(loader.Module):
    ...
    strings = {"name": "RakenStickerMod",
               ...
               "what_photo": "<b>ℹ️ Сделайте реплай на стикер или фото, чтобы добавить его в стикерпак</b>",
               "not_animated_pack": "<b>Ошибка: </b>❌ Анимированные стикеры могут быть добавлены только в паки анимированных стикеров",
               "internal_error": "<b>🤔 Неизвестная внутренняя ошибка</b>",
               "bad_emojis": "<b>Ошибка: </b>❌ Недоступные эмодзи",
